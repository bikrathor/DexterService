...
public class SignUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        confirmPass.setTypeface(FontsManager.getRegularTypeface(getApplicationContext()));
        signup.setTypeface(FontsManager.getBoldTypeface(getApplicationContext()));
        signin.setTypeface(FontsManager.getRegularTypeface(getApplicationContext()));
